...
const vcard = 'BEGIN:VCARD\n' // JAN DI UBAH
            ...
            + 'FN: Irfan\n' // NAMA KONTAK OWNER
            + 'ORG:Creator ANKER;\n' // NAMA CREATOR
            + 'TEL;type=CELL;type=VOICE;waid=62895321033713:+62 895-321-033-713\n' // NOMER HP LU
            + 'END:VCARD'
prefix = '#'
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
				...
				if (!isUser) return reply(mess.only.userB)
                    ...
                    client.sendMessage('62895321033713@s.whatsapp.net', options, text, {quoted: mek})
